  ...
  return (
    <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
      <Card className="h-full">
        <CardHeader>
          <CardTitle className="text-foreground">Couts moyens par type de fournisseur</CardTitle>
          <CardDescription>
            Top 10 categories. Base de calcul: montant transport (C05b).
          </CardDescription>
        </CardHeader>
        <CardContent className="h-[320px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData} margin={{ top: 4, right: 12, left: -4, bottom: 24 }}>
              <defs>
                <linearGradient id="supplierBar" x1="0" y1="0" x2="0" y2="1">
              ...
              />
              <Bar dataKey="average" radius={[10, 10, 0, 0]} fill="url(#supplierBar)" />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
